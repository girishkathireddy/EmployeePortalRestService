...
3. Install  <a href="https://www.mkyong.com/maven/how-to-install-maven-in-windows/">apache maven</a> .(Follow instructions to install Maven)
4. Run command __mvn package__ to packege the war.
